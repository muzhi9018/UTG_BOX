...
// 墨云阁开号机器人用户 id 列表
const MYG_OPEN_ACCOUNT_BOT_USER_ID_LIST = [MYG_OPEN_ACCOUNT_BOT_USER_ID]
...
<code>myg kt2</code> - 回复一条消息直接夸她<br/>
    ...
    private isWelcomingGuests(message: MessageContext): boolean {
        ...
        return (sender.type === 'user' && !sender.isBot && !message.isOutgoing && (text.includes('发电') || text.includes('开号') || text.includes('注册')));
    }
